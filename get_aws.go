...
func OldgetAWSSecret() {
	...
	// Get the list first to get the tags, then for the needed secret get the value

	secretList, err := svc.ListSecrets(listInput)

	for _, value := range secretList.SecretList {
		if *value.Name == secretName {
